...
runuser -l $SUDOUSER -c "wget https://mirror.openshift.com/pub/openshift-v4/x86_64/clients/ocp/$OPENSHIFTVERSION/openshift-install-linux-$OPENSHIFTVERSION.tar.gz"
runuser -l $SUDOUSER -c "wget https://mirror.openshift.com/pub/openshift-v4/x86_64/clients/ocp/$OPENSHIFTVERSION/openshift-client-linux-$OPENSHIFTVERSION.tar.gz"
runuser -l $SUDOUSER -c "tar -xvf openshift-install-linux-$OPENSHIFTVERSION.tar.gz -C $INSTALLERHOME"
runuser -l $SUDOUSER -c "sudo tar -xvf openshift-client-linux-$OPENSHIFTVERSION.tar.gz -C /usr/bin"
